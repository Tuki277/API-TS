...
//update todo
export const findAndUpdateTodo = (query: FilterQuery<TodoDocument>, update: UpdateQuery<TodoDocument>, options: QueryOptions = { lean: true}) => {
    return Todo.findOneAndUpdate(query, update, options)
}

//get to do by id
export const findTodo = async (query: FilterQuery<TodoDocument>, options: QueryOptions = {lean: true}) => {
